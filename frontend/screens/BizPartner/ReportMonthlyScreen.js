...
const ReportMonthlyScreen = () => {
  ...
  const processOrderData = (orders) => {
    ...
    const filteredOrders = orders.filter((order) => {
      const [orderDay, orderMonth, orderYear] = order.dateToDeliver.split("/");
      const orderMonthYear = `${orderMonth}/${orderYear}`; // Format: MM/YYYY
      return (
        orderMonthYear === currentMonth &&
...
export default ReportMonthlyScreen;
